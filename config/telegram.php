...
return [
    ...
    */
    'bots'                         => [
        'bigboost_chatbot' => [
            'token'               => env('TELEGRAM_BOT_USERS_TOKEN', '6246511758:AAEffNJmPfTkj4kvOQAe7P8em1-Whrtb4LU'),
...
//            'webhook_url'         => env('TELEGRAM_WEBHOOK_URL', 'YOUR-BOT-WEBHOOK-URL'),
        ...
        'bb_boosters_bot' => [
            'token'               => env('TELEGRAM_BOT_BOOSTERS_TOKEN', '6050187974:AAEtfmuF_T5kZlVHuyV15bzsPk61ZxEFkWk'),
//            'certificate_path'    => env('TELEGRAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
//            'webhook_url'         => env('TELEGRAM_WEBHOOK_URL', 'YOUR-BOT-WEBHOOK-URL'),
            'commands'            => [
                //Acme\Project\Commands\MyTelegramBot\BotCommand::class
